...
class TransactionController extends Controller
{
    ...
    public function index(TransactionFilterRequest $request): View
    {
        ...
        $transactions = Transaction::whereUserId(auth('customer')->user()->id)
            ->when($transactionFilterData['user_id'] ?? '', function ($query) use ($transactionFilterData) {
        ...
        return view($this->profile . '.dashboard.transaction', ['transactions' => $transactions, 'input' => $request, 'lotteries' => $lotteries, 'transactionTypes' => $transactionTypes, 'statuses' => $statuses]);
    }
