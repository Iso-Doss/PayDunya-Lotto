...
@section('sub-title', __('Réinitialisation de mot de passe'))
...
@section('base.auth.form-sub-title', __('Veuillez fournir les informations ci-dessous afin de réinitialiser votre mot de passe.'))
