{{-- resources/view/administrator/dashboard/profile.blade.php --}}

@extends($profile . '.dashboard.base')

@section('sub-title', __('Profil'))
...
@section('main-content')
    <div class="page-content-wrapper border">
        ...
        <div class="card-body">
            <form class="row g-4 mt-1" action="{{ route($profile . '.profile.update') }}" method="post"
                ...
                {{--            <option--}}
                {{--                value="{{$user_type['value']}}" @selected($user_type['value'] == old('user_type', auth('administrator')->user()->user_type))>--}}
                {{--                {{ $user_type['name'] }}--}}
                {{--            </option>--}}
                {{--        @endforeach--}}
                {{--    </select>--}}
                ...
                <div class="col-md-12">
                    ...
                    <select name="user_type" id="profile-user-type"
                        ...
                        <option
                            value="PHYSICAL-PERSON" @selected('PHYSICAL-PERSON' == old('user_type', auth('administrator')->user()->user_type))>
                            {{ __('Personne Physique (Individu)') }}
                        </option>
                        <option
                            value="CORPORATION" @selected('CORPORATION' == old('user_type', auth('administrator')->user()->user_type))>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="first_name" id="profile-first-name"
                           ...
                           value="{{ old('first_name', auth('administrator')->user()->first_name) }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="last_name" id="profile-last-name"
                           ...
                           value="{{ old('last_name', auth('administrator')->user()->last_name) }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="name" id="profile-name"
                           ...
                           value="{{ old('name', auth('administrator')->user()->name) }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="ifu" id="profile-ifu"
                           ...
                           value="{{ old('ifu', auth('administrator')->user()->ifu) }}"
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="phone_number" id="profile-phone-number"
                               ...
                               value="{{ old('phone_number', auth('administrator')->user()->phone_number) }}"
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control profile-email @error('email'){{'is-invalid'}}@enderror" type="email"
                           name="email" id="profile-email" value="{{ auth('administrator')->user()->email }}"
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="user_name" id="profile-user-name"
                               ...
                               value="{{ old('user_name', auth('administrator')->user()->user_name) }}"
                               placeholder="{{ __('Veuillez entrer votre nom d\'utilisateur') }}">
                    </div>
                    @error('user_name')
                    <div class="form-text text-danger">
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        value="{{ auth('administrator')->user()->registration_number }}"
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control profile-city @error('city'){{'is-invalid'}}@enderror" type="city"
                           name="city" id="profile-city" value="{{ old('city', auth('administrator')->user()->city) }}"
                    ...
                    @if(!@empty($countries))
                        <select name="country_id" id="profile-country"
                            ...
                            @foreach($countries as $country)
                                <option
                                    @selected($country->id == old('country_id', auth('administrator')->user()->country_id)) value="{{ $country->id }}">
                                    {{ $country->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="birthday" id="profile-birthday"
                           ...
                           value="{{ old('birthday', auth('administrator')->user()->birthday) }}"
                ...
                <div class="col-md-6">
                    ...
                    <select name="gender" id="profile-gender"
                        ...
                        <option
                            @selected('FEMALE' == old('gender', auth('administrator')->user()->gender)) value="FEMALE">{{ __('Féminin') }}</option>
                        <option
                            @selected('MALE' == old('gender', auth('administrator')->user()->gender)) value="MALE">{{ __('Masculin') }}</option>
                        <option
                            @selected('OTHER' == old('gender', auth('administrator')->user()->gender)) value="OTHER">{{ __('Autre') }}</option>
                    </select>
                    @error('gender')
                    <div class="form-text text-danger">
                        {{ $message }}
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="address" id="profile-address"
                           ...
                           value="{{ old('address', auth('administrator')->user()->address) }}"
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="website" id="profile-website"
                           ...
                           value="{{ old('website', auth('administrator')->user()->website) }}"
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route($profile . '.profile.update-email') }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input
                                    class="form-control profile-update-email @error('email'){{'is-invalid'}}@enderror"
                                    type="email" name="email" id="profile-update-email"
                                    value="{{ old('email', auth('administrator')->user()->email) }}"
