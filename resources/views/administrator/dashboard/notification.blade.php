{{-- resources/view/administrator/dashboard/notification.blade.php --}}
            ...
            <div class="card-header bg-transparent border-bottom">
                <div class="row mb-3">
                    <div class="col-12 d-sm-flex justify-content-between align-items-center">
                        ...
                        <div>
                            @if(sizeof((auth('administrator')->user()->unreadNotifications)) > 0)
                                <p>
                            ...
                            @if(sizeof((auth('administrator')->user()->readNotifications)) > 0)
                                <p>
                            ...
                            @if(sizeof((auth('administrator')->user()->notifications)) > 0)
                                <p>
                                    <a href="#" class="link-danger" data-bs-toggle="modal"
