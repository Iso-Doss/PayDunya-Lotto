                ...
                <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                    ...
                    <p style="font-size: 14px; line-height: 160%; text-align: left;">
                        ...
                        <span style="font-size: 18px; line-height: 28.8px;">
                            ...
                            {{ __('Nous avons bien reçu votre demande de changement d\'adresse email. Veuillez cliquer sur le lien ci-dessous afin de définir une nouvelle adresse mail pour votre compte.') }}
