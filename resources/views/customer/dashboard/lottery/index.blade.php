{{-- resources/view/customer/dashboard/lottery/index.blade.php --}}
                                    ...
                                    <p>
                                        @if(!is_null($lottery->status))
                                            ...
                                            @elseif('A_WINNER' == $lottery->status?->code)
                                                ...
                                                @if($lottery->pivot->amount > 0 && !is_null($lottery->pivot->amount))
                                                    <span class="badge bg-success bg-opacity-10 text-success">
                                                        {{ __('Vous etes le gagnant de cette loterie.') }}
                                                    </span>
                                                @endif
                                            @elseif('MULTIPLE_WINNER' == $lottery->status?->code)
                                                ...
                                                @if($lottery->pivot->amount > 0 && !is_null($lottery->pivot->amount))
                                                    <span class="badge bg-success bg-opacity-10 text-success">
                                                        {{ __('Vous faites partir des gagnant de cette loterie.') }}
                                                    </span>
                                                @endif
                                            @endif
                                        @endif
