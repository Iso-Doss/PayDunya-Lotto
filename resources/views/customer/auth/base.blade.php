{{-- ressources/views/customer/auth/base.blade.php --}}
                    ...
                    <div
                        ...
                        <div class="p-3 p-lg-5">
                            ...
                            <div class="text-center">
                                <h2 class="fw-bold">@yield('base.auth.title', __('Bienvenu chèr(e) client(e) sur :app-name.', ['app-name' => config('app.name')]))</h2>
                    ...
                    <div class="col-12 col-lg-6 m-auto">
                        <div class="row my-5">
                            <div class="col-sm-10 col-xl-8 m-auto">
                                ...
                                <p class="lead mb-4">@yield('base.auth.form-sub-title', __('Ravi de vous voir, Chèr(e) client(e) ! Veuillez vous inscrire avec votre compte.'))</p>
