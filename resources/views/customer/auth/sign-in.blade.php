{{-- resources/view/customer/auth/sign-in.blade.php --}}
...
@section('base.auth.form-sub-title', __('Ravi de vous voir, Chèr(e) client(e) ! Veuillez vous connecter avec votre compte.'))
